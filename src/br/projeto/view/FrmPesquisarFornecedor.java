...
//    }
    ...
    private FrmDadosPedidosOK FrmDadosPedidosOK;
    
    public FrmPesquisarFornecedor() {        
        initComponents();       
        
    }
    public FrmPesquisarFornecedor(FrmDadosPedidosOK FrmDadosPedidosOK){
        this.FrmDadosPedidosOK = FrmDadosPedidosOK;        
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        FrmDadosPedidosOK.TxtFornecedorDados.setText(jTable1.getValueAt(jTable1.getSelectedRow(),1).toString());
        FrmDadosPedidosOK.TxtIdFonecedor.setText(jTable1.getValueAt(jTable1.getSelectedRow(),0).toString());
        FrmDadosPedidosOK.TxtCnpj.setText(jTable1.getValueAt(jTable1.getSelectedRow(),2).toString());
